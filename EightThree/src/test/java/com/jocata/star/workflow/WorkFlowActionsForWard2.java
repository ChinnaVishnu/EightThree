...
public class WorkFlowActionsForWard2 extends mainbaseLatest {
	...
	public void clickDashboard() throws IOException {
		...
		try {
			...
			fluentWait(By.linkText("Forward")).click();
			// sleep(10);
			 ...
			 * 
			 * 
			 * fluentWait(By.xpath("//div[3]/div/table/tbody/tr/td/div/div")).
			 * click();
			 * 
			 * fluentWait(By.xpath("//span[@id='assgnBtn-btnEl']/span[2]")).
			 * click(); sleep(2);
			 * fluentWait(By.xpath("//div[3]/div/div/a/span/span/span[2]")).
			 * click();
			 * 
			 * sleep(2);
			 */
