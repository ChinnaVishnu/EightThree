...
import com.jocata.star.DatabaseReports.DBBenchMarkReport;
import com.jocata.star.PdfReports.BenchMarkDetailsPdfReport;
import com.jocata.star.basescripts.ExtentTestManager;
import com.jocata.star.basescripts.GetScreenshort;
import com.jocata.star.basescripts.mainbaseLatest;
import com.relevantcodes.extentreports.LogStatus;

public class BenchmarksReportExport extends mainbaseLatest {
	...
	Thread.sleep(20000);
		...
		BenchMarkDetailsPdfReport ss = new BenchMarkDetailsPdfReport();
		String pp = ss.Start();
	...
	String rr=	  DBBenchMarkReport.getEmployeesFromDataBase(); 
